    ...
    <div className="min-h-screen bg-gray-900 flex flex-col">
      ...
      <main className="flex-1 px-6 pb-12 pt-4 sm:pt-8">
        <div className="max-w-6xl mx-auto space-y-6">
          <section className="grid grid-cols-1 xl:grid-cols-[1.05fr_1.2fr] gap-6 items-stretch">
            <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-gray-900 via-gray-900 to-red-950/40 p-8 sm:p-10 flex flex-col justify-between min-h-[320px]">
              <div>
                <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs uppercase tracking-[0.3em] text-gray-400 mb-5">
                  Mission
                </div>
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Link
              to="/sec-timeline"
              className="group bg-gray-800 border border-gray-700 rounded-2xl p-6 hover:border-blue-500 hover:bg-gray-800/80 transition-all sm:min-h-[160px]"
            >
            ...
            <Link
              to="/executive-comp"
              className="group bg-gray-800 border border-gray-700 rounded-2xl p-6 hover:border-green-500 hover:bg-gray-800/80 transition-all sm:min-h-[160px]"
            >
